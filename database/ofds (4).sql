...
(39, 43, 43, NULL, 1, 0, 'Organic', 'Organic Product', '2023-07-11 16:30:15', '2023-07-11 16:36:51');
...
(14, 42, 42, 'Bat Tola Jame Mosque', 'Mosque', 1, 0, '5345212635', NULL, '10', 'Jordia', '10', 'Fingri', 'Satkhira Sadar', 'Satkhira', '9400', 'Khulna', 'Bangladesh', NULL, 'assets/back-end/community/profile/', NULL, 'assets/back-end/community/cover/', '2023-07-11 14:13:48', '2023-07-11 14:13:48'),
(15, 45, 45, 'Central Community', 'Mosque', 1, 0, '65464515', NULL, NULL, NULL, NULL, 'City Corporation', 'Satkhira Sadar', 'Satkhira', '9400', 'Khulna', 'Bangladesh', NULL, 'assets/back-end/community/profile/', NULL, 'assets/back-end/community/cover/', '2023-07-11 17:06:21', '2023-07-11 17:30:35');

-- --------------------------------------------------------

--
-- Table structure for table `community_order_from_shops`
--

CREATE TABLE `community_order_from_shops` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `order_id` bigint(20) UNSIGNED NOT NULL COMMENT 'order_products table id',
  `shop_id` bigint(20) UNSIGNED NOT NULL COMMENT 'shop_infos table id',
  `community_id` bigint(20) UNSIGNED NOT NULL COMMENT 'communities table id',
  `status` int(11) NOT NULL DEFAULT 1 COMMENT '1=shop request community, 2=accept,3=delivery, 5=unable to accept',
  `seen_status` int(11) NOT NULL DEFAULT 0 COMMENT '0=unseen, 1=seen',
...
--
-- Dumping data for table `community_order_from_shops`
--

INSERT INTO `community_order_from_shops` (`id`, `order_id`, `shop_id`, `community_id`, `status`, `seen_status`, `request_time`, `response_time`, `created_at`, `updated_at`) VALUES
(1, 31, 12, 14, 3, 1, '2023-07-16 15:13:04', '2023-08-15 06:27:23', '2023-07-16 15:13:04', '2023-08-15 06:27:23'),
(2, 34, 12, 14, 3, 1, '2023-08-15 14:05:28', '2023-08-15 14:16:38', '2023-08-15 14:05:28', '2023-08-15 14:16:38');
...
(23, '2023_07_05_182225_update_order_products_table', 5),
(24, '2023_07_14_224513_create_vendor_community_lists', 6),
(25, '2023_07_15_221059_create_community_order_from_shop_table', 7),
(26, '2023_08_12_211448_create_order_status_table', 8);
...
CREATE TABLE `orders` (
  ...
  `delivery_person_id` bigint(20) DEFAULT NULL COMMENT 'Community ID',
  ...
  `payment_method` varchar(255) DEFAULT NULL COMMENT '1=online payment, 2=cash on delivery',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `orders` (`id`, `invoice_id`, `order_id`, `customer_id`, `delivery_person_id`, `delivery_address`, `district`, `division`, `country`, `c_name`, `c_phone`, `c_email`, `order_status`, `order_complete_status`, `product_count`, `price`, `shipping_charge`, `payment_method`, `created_at`, `updated_at`) VALUES
(1, '1000', '231812', 4, 1, 'House: , Road: , Village: dhaka, Word: , Union: Dhaka, Upazila: Ishurdi, Zip Code: , District: Pabna, Division: Rajshahi, Country: Bangladesh, Extra Info: ', NULL, NULL, NULL, 'Md. Ismile', '12345678954', 'user@ofds.com', 1, 0, '2', '50220', '70', '2', '2023-06-16 23:18:30', '2023-06-16 23:18:30'),
(2, '1001', '726594', 4, 1, 'House: , Road: , Village: dhaka, Word: , Union: Dhaka, Upazila: Dhaka North CC, Zip Code: , District: Dhaka, Division: Dhaka, Country: Bangladesh, Extra Info: ', NULL, NULL, NULL, 'Md. Ismile', '12345678954', 'user@ofds.com', 0, 0, '1', '150000', '60', '2', '2023-06-16 23:19:02', '2023-06-17 05:34:43'),
(3, '1002', '642614', 9, 2, 'House: , Road: 1, Village: Kolabagan, Word: , Union: Panchgachia, Upazila: Feni Sadar, Zip Code: , District: Feni, Division: Chattagram, Country: Bangladesh, Extra Info: ', NULL, NULL, NULL, 'Shuvro K', '01729357787', 'skshubroto@gmail.com', 1, 0, '1', '220', '60', '2', '2023-06-17 00:29:22', '2023-06-17 00:29:22'),
(4, '1003', '416244', 15, 6, 'House: , Road: , Village: Fulbaria, Word: , Union: Fulbaria, Upazila: Fulbaria, Zip Code: , District: Mymensingh, Division: Mymensingh, Country: Bangladesh, Extra Info: ', NULL, NULL, NULL, 'arnob roy', '21136465789', 'arnob@gmail.com', 1, 0, '1', '800', '70', '2', '2023-06-17 04:16:26', '2023-06-17 04:16:26'),
(5, '1004', '197605', 18, 7, 'House: , Road: , Village: Durgapur, Word: , Union: Durgapur, Upazila: Pirojpur Sadar, Zip Code: , District: Pirojpur, Division: Barisal, Country: Bangladesh, Extra Info: ', NULL, NULL, NULL, 'Helal khan', '36925814778', 'helal@gmAail.com', 1, 0, '1', '10500', '70', '2', '2023-06-17 05:06:50', '2023-06-17 05:06:50'),
(6, '1005', '775229', 22, 8, 'House: , Road: , Village: Deukhola, Word: , Union: Deukhola, Upazila: Nazirhat, Zip Code: , District: Chattogram, Division: Chattagram, Country: Bangladesh, Extra Info: ', NULL, NULL, NULL, 'Hamidur Rahman', '74125896332', 'hamid@gmail.com', 1, 0, '1', '5118', '60', '2', '2023-06-17 05:46:41', '2023-06-17 05:46:41'),
(7, '1006', '803790', 21, 8, 'House: , Road: , Village: Barasat, Word: , Union: Barasat, Upazila: Anwara, Zip Code: , District: Chattogram, Division: Chattagram, Country: Bangladesh, Extra Info: ', NULL, NULL, NULL, 'james dohn', '12345698715', 'james@gmail.com', 1, 0, '1', '11999', '60', '2', '2023-06-17 05:50:40', '2023-06-17 05:50:40'),
(8, '1007', '27856', 5, 1, 'House: , Road: , Village: dhaka, Word: , Union: Dhaka, Upazila: Dhaka South CC, Zip Code: , District: Dhaka, Division: Dhaka, Country: Bangladesh, Extra Info: ', NULL, NULL, NULL, 'Community 1', '12345678215', 'community@ofds.com', 0, 0, '1', '60', '60', '2', '2023-06-19 10:43:41', '2023-06-19 12:32:37'),
(9, '1008', '121435', 25, 9, 'House: , Road: , Village: Cantonment, Word: , Union: Cantonment, Upazila: Dhaka North CC, Zip Code: , District: Dhaka, Division: Dhaka, Country: Bangladesh, Extra Info: ', NULL, NULL, NULL, 'Jamal Bhuiya', '25835715984', 'jamal123456@gmail.com', 1, 0, '1', '2998', '60', '2', '2023-06-23 00:36:34', '2023-06-23 00:36:34'),
(10, '1009', '423247', 25, 9, 'House: , Road: , Village: Cantonment, Word: , Union: Cantonment, Upazila: Dhaka North CC, Zip Code: , District: Dhaka, Division: Dhaka, Country: Bangladesh, Extra Info: ', NULL, NULL, NULL, 'Jamal Bhuiya', '25835715984', 'jamal123456@gmail.com', 1, 0, '1', '699', '60', '2', '2023-06-23 01:39:02', '2023-06-23 01:39:02'),
(11, '1010', '428792', 27, 9, 'House: , Road: , Village: Cantonment, Word: , Union: cantonment, Upazila: Dhaka North CC, Zip Code: , District: Dhaka, Division: Dhaka, Country: Bangladesh, Extra Info: ', NULL, NULL, NULL, 'rabeya khan', '78946432133', 'rabeyakhan@gmail.com', 1, 0, '1', '699', '60', '2', '2023-06-23 01:42:58', '2023-06-23 01:42:58'),
(12, '1011', '269640', 25, 9, 'House: , Road: , Village: Cantonment, Word: , Union: Cantonment, Upazila: Dhaka North CC, Zip Code: , District: Dhaka, Division: Dhaka, Country: Bangladesh, Extra Info: ', NULL, NULL, NULL, 'Jamal Bhuiya', '25835715984', 'jamal123456@gmail.com', 1, 0, '1', '899', '60', '2', '2023-06-23 01:46:06', '2023-06-23 01:46:06'),
(13, '1012', '329317', 25, 9, 'House: , Road: , Village: Cantonment, Word: , Union: Cantonment, Upazila: Dhaka North CC, Zip Code: , District: Dhaka, Division: Dhaka, Country: Bangladesh, Extra Info: ', NULL, NULL, NULL, 'Jamal Bhuiya', '25835715984', 'jamal123456@gmail.com', 1, 0, '1', '799', '60', '2', '2023-06-23 02:09:24', '2023-06-23 02:09:24'),
(14, '1013', '36302', 27, 9, 'House: , Road: , Village: Cantonment, Word: , Union: cantonment, Upazila: Dhaka North CC, Zip Code: , District: Dhaka, Division: Dhaka, Country: Bangladesh, Extra Info: ', NULL, NULL, NULL, 'rabeya khan', '78946432133', 'rabeyakhan@gmail.com', 1, 0, '1', '1439.1', '60', '2', '2023-06-23 03:14:00', '2023-06-23 03:14:00'),
(15, '1014', '945035', 27, 9, 'House: , Road: , Village: Cantonment, Word: , Union: cantonment, Upazila: Dhaka North CC, Zip Code: , District: Dhaka, Division: Dhaka, Country: Bangladesh, Extra Info: ', NULL, NULL, NULL, 'rabeya khan', '78946432133', 'rabeyakhan@gmail.com', 1, 0, '1', '1439.1', '60', '2', '2023-06-23 03:16:59', '2023-06-23 03:16:59'),
(16, '1015', '152381', 30, 10, 'House: , Road: , Village: Hemayetpur, Word: , Union: Hemayetpur, Upazila: Pabna Sadar, Zip Code: , District: Pabna, Division: Rajshahi, Country: Bangladesh, Extra Info: ', NULL, NULL, NULL, 'user user', '36251487940', 'useruser@gmail.com', 0, 0, '1', '3500', '70', '2', '2023-06-23 04:33:35', '2023-06-23 04:39:17'),
(17, '1016', '852796', 30, 10, 'House: , Road: , Village: Hemayetpur, Word: , Union: Hemayetpur, Upazila: Pabna Sadar, Zip Code: , District: Pabna, Division: Rajshahi, Country: Bangladesh, Extra Info: ', NULL, NULL, NULL, 'user user', '36251487940', 'useruser@gmail.com', 1, 0, '2', '1598', '70', '2', '2023-06-23 05:13:27', '2023-06-23 05:13:27'),
(18, '1017', '535347', 33, 1, 'House: , Road: , Village: sector 10, Word: , Union: sector 10, Upazila: Dhaka North CC, Zip Code: , District: Dhaka, Division: d, Country: Bangladesh, Extra Info: ', NULL, NULL, NULL, 'user person', '02316549874', 'person@gmail.com', 1, 0, '2', '2500', '180', '2', '2023-06-23 06:13:01', '2023-06-23 06:13:01'),
(19, '1018', '878931', 36, 1, 'House: , Road: , Village: kolabagan, Word: , Union: kolabagan, Upazila: Dhaka South CC, Zip Code: , District: Dhaka, Division: Dhaka, Country: Bangladesh, Extra Info: ', NULL, NULL, NULL, 'hi user', '03215698478', 'hiuser@gmail.com', 0, 0, '1', '1999', '60', '2', '2023-06-23 07:15:42', '2023-06-23 07:16:20'),
(20, '1019', '328779', 39, 13, 'House: , Road: , Village: Pakshi, Word: , Union: Pakshi, Upazila: Ishurdi, Zip Code: , District: Pabna, Division: Rajshahi, Country: Bangladesh, Extra Info: ', NULL, NULL, NULL, 'Mr R', '12346484984', 'mrr@gmail.com', 0, 0, '1', '1000', '70', '2', '2023-06-23 07:45:08', '2023-06-23 07:46:04'),
(21, '1020', '639887', 4, 1, 'House: , Road: , Village: dhaka, Word: , Union: Dhaka, Upazila: Dhaka North CC, Zip Code: , District: Dhaka, Division: Dhaka, Country: Bangladesh, Extra Info: ', NULL, NULL, NULL, 'Md. Ismile', '12345678954', 'user@ofds.com', 1, 0, '1', '3325', '60', '2', '2023-07-05 12:32:07', '2023-07-05 12:32:07'),
(22, '1021', '489870', 8, 2, 'House: , Road: , Village: Kashipur, Word: , Union: Kashipur, Upazila: Phulbari, Zip Code: , District: Kurigram, Division: Rangpur, Country: Bangladesh, Extra Info: ', NULL, NULL, NULL, 'Md. Sojib', '12457895432', 'sojib@ofds.com', 1, 0, '2', '8649', '60', '2', '2023-07-07 17:48:09', '2023-07-07 17:48:09'),
(23, '1022', '772', 4, 1, 'House: , Road: , Village: dhaka, Word: , Union: Dhaka, Upazila: Dhaka North CC, Zip Code: , District: Dhaka, Division: Dhaka, Country: Bangladesh, Extra Info: ', NULL, NULL, NULL, 'Md. Ismile', '12345678954', 'user@ofds.com', 1, 0, '1', '3325', '40', '2', '2023-07-08 14:21:50', '2023-07-08 14:21:50'),
(24, '1023', '703685', 4, 5, 'House: , Road: , Village: gulsan, Word: , Union: Gulshan, Upazila: Dhaka South CC, Zip Code: , District: Dhaka, Division: Dhaka, Country: Bangladesh, Extra Info: ', NULL, NULL, NULL, 'Md. Ismile', '12345678954', 'user@ofds.com', 1, 0, '2', '4325', '40', '2', '2023-07-08 15:28:21', '2023-07-08 15:28:21'),
(25, '1024', '336490', 41, 14, 'House: , Road: 95, Village: jordia, Word: 10, Union: Fingri, Upazila: Satkhira Sadar, Zip Code: 9400, District: Satkhira, Division: Khulna, Country: Bangladesh, Extra Info: ', NULL, NULL, NULL, 'User Jordia', '45454531341', 'jordia@ofds.com', 1, 0, '1', '1000', '20', '2', '2023-07-13 17:18:32', '2023-07-13 17:18:32'),
(26, '1025', '316825', 41, 14, 'House: , Road: , Village: jordia, Word: 10, Union: Fingri, Upazila: Satkhira Sadar, Zip Code: 9400, District: Satkhira, Division: Khulna, Country: Bangladesh, Extra Info: ', NULL, NULL, NULL, 'User Jordia', '45454531341', 'jordia@ofds.com', 1, 0, '1', '500', '20', '2', '2023-07-14 14:14:31', '2023-07-14 14:14:31'),
(27, '1026', '621478', 41, 14, 'House: , Road: , Village: Jordia, Word: , Union: Fingri, Upazila: Satkhira Sadar, Zip Code: , District: Satkhira, Division: Khulna, Country: Bangladesh, Extra Info: ', 'Satkhira', 'Khulna', 'Bangladesh', 'User Jordia', '45454531341', 'jordia@ofds.com', 1, 0, '2', '600', '20', '2', '2023-07-15 14:36:40', '2023-07-15 14:36:40'),
(28, '1027', '421446', 4, 1, 'House: , Road: , Village: dhaka, Word: , Union: Dhaka, Upazila: Dhaka North CC, Zip Code: 1207, District: Dhaka, Division: Dhaka, Country: Bangladesh, Extra Info: ', 'Dhaka', NULL, NULL, 'Md. Ismile', '12345678954', 'user@ofds.com', 1, 0, '1', '500', '40', '2', '2023-08-15 13:50:16', '2023-08-15 13:50:16'),
(29, '1028', '692152', 41, 14, 'House: , Road: , Village: , Word: , Union: , Upazila: Lalmai, Zip Code: , District: Satkhira, Division: Khulna, Country: Bangladesh, Extra Info: ', 'Satkhira', 'Khulna', 'Bangladesh', 'User Jordia', '45454531341', 'jordia@ofds.com', 1, 0, '1', '500', '20', '2', '2023-08-25 06:06:49', '2023-08-25 06:06:49'),
(30, '1029', '282232', 42, 14, 'House: , Road: , Village: Jordia, Word: , Union: Fingri, Upazila: Satkhira Sadar, Zip Code: 9400, District: Satkhira, Division: Khulna, Country: Bangladesh, Extra Info: ', 'Satkhira', 'Khulna', 'Bangladesh', 'Community Jordia', '86454556453', 'communityjordia@ofds.com', 1, 0, '1', '400', '20', '2', '2023-08-25 10:32:55', '2023-08-25 10:32:55'),
(31, '1030', '785334', 41, 15, 'House: , Road: , Village: , Word: , Union: , Upazila: Satkhira Sadar, Zip Code: , District: Satkhira, Division: Khulna, Country: Bangladesh, Extra Info: ', 'Satkhira', 'Khulna', 'Bangladesh', 'User Jordia', '45454531341', 'jordia@ofds.com', 1, 0, '1', '100', '20', '2', '2023-08-25 12:13:16', '2023-08-25 12:13:16');
...
CREATE TABLE `order_products` (
  ...
  `order_status` int(11) NOT NULL DEFAULT 1 COMMENT '0=inactive, 1=primary,2=accept,3= vendor regional admin, 4=customer regional admin, 5=hand over to delivery person, 6=received delivery man,7= received customer/completed, 8=summited review/final completed,9=vendor submit request to admin, 10=admin to admin, 11=vendor to community, 12=vendor community hub, 13=community request to customer\r\n',
...
INSERT INTO `order_products` (`id`, `order_id`, `product_id`, `customer_id`, `vendor_id`, `order_status`, `order_quantity`, `delivery_quantity`, `unite_price`, `total_price`, `discount`, `discount_total`, `tax_amount`, `payment_status`, `created_by`, `updated_by`, `number_of_updated`, `created_at`, `updated_at`) VALUES
(1, 231812, 3, 4, 6, 1, 1, NULL, '50000', '50000', NULL, NULL, 0, 0, 4, 4, 0, '2023-06-16 23:18:30', '2023-06-17 04:53:18'),
(2, 231812, 2, 4, 3, 2, 1, NULL, '220', '220', NULL, NULL, 0, 0, 4, 4, 0, '2023-06-16 23:18:30', '2023-06-23 08:14:52'),
(3, 726594, 3, 4, 6, 1, 3, NULL, '50000', '150000', NULL, NULL, 0, 0, 4, 4, 0, '2023-06-16 23:19:02', '2023-06-17 05:34:43'),
(4, 642614, 2, 9, 3, 3, 1, NULL, '220', '220', NULL, NULL, 0, 0, 9, NULL, 0, '2023-06-17 00:29:22', '2023-06-23 08:13:52'),
(5, 416244, 10, 15, 14, 1, 1, NULL, '800', '800', NULL, NULL, 0, 0, 15, NULL, 0, '2023-06-17 04:16:26', '2023-06-17 04:16:26'),
(6, 197605, 11, 18, 17, 1, 1, NULL, '10500', '10500', NULL, NULL, 0, 0, 18, NULL, 0, '2023-06-17 05:06:50', '2023-06-17 05:06:50'),
(7, 775229, 14, 22, 20, 1, 2, NULL, '2559', '5118', NULL, NULL, 0, 0, 22, NULL, 0, '2023-06-17 05:46:40', '2023-06-17 05:46:40'),
(8, 803790, 13, 21, 20, 1, 1, NULL, '11999', '11999', NULL, NULL, 0, 0, 21, NULL, 0, '2023-06-17 05:50:40', '2023-06-17 05:50:40'),
(9, 27856, 20, 5, 17, 0, 1, NULL, '60', '60', NULL, NULL, 0, 0, 5, 5, 0, '2023-06-19 10:43:41', '2023-06-19 12:21:28'),
(10, 121435, 19, 25, 23, 1, 2, NULL, '1499', '2998', NULL, NULL, 0, 0, 25, NULL, 0, '2023-06-23 00:36:34', '2023-06-23 00:36:34'),
(11, 423247, 35, 25, 27, 2, 1, NULL, '699', '699', NULL, NULL, 0, 0, 25, NULL, 0, '2023-06-23 01:39:02', '2023-06-23 01:41:23'),
(12, 428792, 35, 27, 27, 1, 1, NULL, '699', '699', NULL, NULL, 0, 0, 27, NULL, 0, '2023-06-23 01:42:58', '2023-06-23 01:42:58'),
(13, 269640, 34, 25, 27, 1, 1, NULL, '899', '899', NULL, NULL, 0, 0, 25, NULL, 0, '2023-06-23 01:46:06', '2023-06-23 01:46:06'),
(14, 329317, 29, 25, 27, 1, 1, NULL, '799', '799', NULL, NULL, 0, 0, 25, NULL, 0, '2023-06-23 02:09:23', '2023-06-23 02:09:23'),
(15, 36302, 30, 27, 27, 1, 1, NULL, '1439.1', '1439.1', NULL, NULL, 0, 0, 27, NULL, 0, '2023-06-23 03:14:00', '2023-06-23 03:14:00'),
(16, 945035, 32, 27, 27, 1, 1, NULL, '1439.1', '1439.1', NULL, NULL, 0, 0, 27, NULL, 0, '2023-06-23 03:16:59', '2023-06-23 03:16:59'),
(17, 152381, 45, 30, 29, 2, 1, NULL, '3500', '3500', NULL, NULL, 0, 0, 30, NULL, 0, '2023-06-23 04:33:35', '2023-06-23 04:34:08'),
(18, 852796, 34, 30, 27, 1, 1, NULL, '899', '899', NULL, NULL, 0, 0, 30, NULL, 0, '2023-06-23 05:13:27', '2023-06-23 05:13:27'),
(19, 852796, 35, 30, 27, 1, 1, NULL, '699', '699', NULL, NULL, 0, 0, 30, NULL, 0, '2023-06-23 05:13:27', '2023-06-23 05:13:27'),
(20, 535347, 53, 33, 32, 2, 1, NULL, '1500', '1500', NULL, NULL, 0, 0, 33, NULL, 0, '2023-06-23 06:13:00', '2023-06-23 06:23:36'),
(21, 535347, 52, 33, 32, 1, 1, NULL, '1000', '1000', NULL, NULL, 0, 0, 33, NULL, 0, '2023-06-23 06:13:00', '2023-06-23 06:13:00'),
(22, 878931, 55, 36, 35, 0, 1, NULL, '1999', '1999', NULL, NULL, 0, 0, 36, 36, 0, '2023-06-23 07:15:42', '2023-06-23 07:16:20'),
(23, 328779, 56, 39, 38, 9, 1, NULL, '1000', '1000', NULL, NULL, 0, 0, 39, NULL, 0, '2023-06-23 07:45:08', '2023-06-23 08:35:17'),
(24, 639887, 57, 4, 38, 1, 1, NULL, '3325', '3325', '175', '175', 0, 0, 4, NULL, 0, '2023-07-05 12:32:07', '2023-07-05 12:32:07'),
(25, 489870, 55, 8, 35, 1, 1, NULL, '1999', '1999', '0', '0', 0, 0, 8, NULL, 0, '2023-07-07 17:48:09', '2023-07-07 17:48:09'),
(26, 489870, 57, 8, 38, 1, 2, NULL, '3325', '6650', '175', '350', 0, 0, 8, NULL, 0, '2023-07-07 17:48:09', '2023-07-07 17:48:09'),
(27, 772, 57, 4, 38, 9, 1, NULL, '3325', '3325', '175', '175', 0, 0, 4, NULL, 0, '2023-07-08 14:21:50', '2023-07-08 14:44:38'),
(28, 703685, 57, 4, 38, 9, 1, NULL, '3325', '3325', '175', '175', 0, 0, 4, NULL, 0, '2023-07-08 15:28:20', '2023-07-08 15:50:31'),
(29, 703685, 56, 4, 38, 1, 1, NULL, '1000', '1000', '0', '0', 0, 0, 4, NULL, 0, '2023-07-08 15:28:21', '2023-07-08 15:28:21'),
(30, 336490, 56, 41, 38, 1, 1, NULL, '1000', '1000', '0', '0', 0, 0, 41, NULL, 0, '2023-07-13 17:18:32', '2023-07-13 17:18:32'),
(31, 316825, 58, 41, 43, 7, 1, 1, '500', '500', '0', '0', 0, 0, 41, 41, 2, '2023-07-14 14:14:31', '2023-08-25 16:00:19'),
(32, 621478, 59, 41, 43, 4, 1, NULL, '100', '100', '0', '0', 0, 0, 41, 46, 3, '2023-07-15 14:36:40', '2023-08-25 17:12:22'),
(34, 421446, 58, 4, 43, 7, 1, 1, '500', '500', '0', '0', 0, 0, 4, 4, 5, '2023-08-15 13:50:16', '2023-08-25 15:55:05'),
(35, 692152, 58, 41, 43, 12, 1, NULL, '500', '500', '0', '0', 0, 0, 41, 46, 1, '2023-08-25 06:06:49', '2023-08-25 17:15:57'),
(36, 282232, 59, 42, 43, 1, 4, NULL, '100', '400', '0', '0', 0, 0, 42, NULL, 0, '2023-08-25 10:32:55', '2023-08-25 10:32:55'),
(37, 785334, 59, 41, 43, 1, 1, NULL, '100', '100', '0', '0', 0, 0, 41, NULL, 0, '2023-08-25 12:13:16', '2023-08-25 12:13:16');
...
INSERT INTO `order_statuses` (`id`, `status_name`, `status_value`, `badge`, `title`, `created_at`, `updated_at`) VALUES
(1, 'Canceled', '0', 'bg-danger', NULL, '2023-08-14 17:21:17', '2023-08-14 17:21:17'),
(2, 'Primary', '1', 'bg-primary', NULL, '2023-08-14 17:24:49', '2023-08-14 17:24:49'),
(3, 'Accepted', '2', 'bg-info', NULL, '2023-08-14 17:38:36', '2023-08-14 17:38:36'),
(4, 'H/O Logistic', '3', 'bg-primary', 'Handed over on vendor site logistic partner', '2023-08-14 17:48:53', '2023-08-14 17:48:53'),
(5, 'Waiting for Delivery Community', '4', 'bg-success', 'Waiting for Delivery Community', '2023-08-14 17:49:32', '2023-08-14 17:49:32'),
(6, 'Received delivery community', '5', 'bg-warning', 'Received delivery community', '2023-08-14 17:50:23', '2023-08-14 17:50:23'),
(7, 'Community Request to Customer', '6', 'bg-success', 'Community Request to Customer for receive product', '2023-08-14 17:50:45', '2023-08-14 17:50:45'),
(8, 'Received', '7', 'bg-info', 'Customer Received Product', '2023-08-14 17:51:15', '2023-08-14 17:51:15'),
(9, 'Reviewed', '8', 'bg-warning', NULL, '2023-08-14 17:52:07', '2023-08-14 17:52:07'),
(10, 'Shop Request to Admin', '9', 'bg-warning', 'Vendor request to admin', '2023-08-14 17:52:54', '2023-08-14 17:52:54'),
(11, 'Admin to Admin Request', '10', 'bg-info', 'Vendor site admin to Customer site admin request', '2023-08-14 17:53:17', '2023-08-14 17:53:17'),
(12, 'Request to community', '11', 'bg-warning', 'Vendor request to community', '2023-08-14 17:53:42', '2023-08-14 17:53:42'),
(13, 'Vendor community Hub', '12', 'bg-info', 'Vendor site community Hub', '2023-08-14 17:54:21', '2023-08-14 17:54:21'),
(15, 'Customer Site Admin Hub', '13', 'bg-info', 'Customer Site Admin Hub', '2023-08-24 10:46:29', NULL),
(16, 'Vendor site community request to admin', '14', 'bg-warning', 'Vendor site community request to admin', '2023-08-25 04:35:42', NULL);
...
CREATE TABLE `products` (
  ...
  `vendor_id` bigint(20) NOT NULL COMMENT 'Users table id',
  `creater_id` bigint(20) NOT NULL,
...
(58, 1, 0, 0, 43, 43, 43, 39, 'Fresh Fish', '500', 'Fresh Fish', 100, 'Fresh_Fish_70636_tilapia-fish.jpeg', 0, NULL, NULL, NULL, NULL, '2023-07-11 16:48:27', '2023-07-11 16:48:27'),
(59, 1, 0, 0, 43, 43, 43, 39, 'Mango', '100', 'Mango', 500, 'Mango_73893_download.jpeg', 0, NULL, NULL, NULL, NULL, '2023-07-15 14:35:42', '2023-07-15 14:35:42');
...
(9, 'Rangpur', '2', '80', '1', '1', '2023-05-30 09:40:29', '2023-07-08 14:18:30'),
...
(16, 'Dhaka', '3', '40', '1', NULL, '2023-07-08 14:19:35', '2023-07-08 14:19:35'),
(17, 'Satkhira', '3', '20', '1', '1', '2023-07-11 18:36:53', '2023-07-11 18:37:25');
...
(12, 43, 43, 'Village Shop', 1, 0, '12345646431', '20:56', '08:57', NULL, '10', 'Jordia', '10', 'Fingri', 'Satkhira Sadar', 'Satkhira', '9400', 'Khulna', 'Bangladesh', 'Village_profile_Shop_66217_profile-2.jpg', 'assets/back-end/vendor/profile/', 'Village_Shop_cover_15371_930px-Desktop.jpg', 'assets/back-end/vendor/cover/', '2023-07-11 14:57:24', '2023-07-11 14:57:24');
...
(2, 'Admin Dhaka 1', 'admindhaka1@ofds.com', '01877772225', '15/E', 'Kolabagan', '10', 'Kolabagan', 'Dhaka South CC', 'Dhaka', '1205', 'Dhaka', 'Bangladesh', NULL, '$2y$10$mT09n2mxnOJ1SBiUfZ1SOemZDVv2UI/EZW5l2Nc86e9OMqEYtvzZ.', NULL, '2023-05-30 09:30:01', '2023-07-08 15:59:21', 1, 0, 'Admin', 'Dhaka 1', 1, 'Islam', '1996-03-16', 'assets/img/profile/', 'Admin_75824_DSC_0161.JPG', 1),
...
(29, 'Cooking Shop', 'cookingshop@ofds.com', '14862684123', NULL, 'Hemayetpur', NULL, 'Hemayetpur', 'Pabna Sadar', 'Pabna', '6602', 'Rajshahi', 'Bangladesh', NULL, '$2y$10$JH53/Brhgjh6bMUIKmD.Kug3zmn46LDCq.tobUs38RhqBxUW7oAza', NULL, '2023-06-23 03:31:01', '2023-07-08 14:40:12', 1, 0, 'Cooking', 'Shop', 2, 'Hinduism', '1996-03-01', 'assets/img/profile/', NULL, 1),
...
(38, 'Cooking Tools', 'cookingtools@ofds.com', '75951535465', NULL, 'Pakshi', NULL, 'Pakshi', 'Ishurdi', 'Pabna', '6622', 'Rajshahi', 'Bangladesh', NULL, '$2y$10$N0MveHlm6lfDWl9czuCdkONdjUcMrWgNMkyRKvF4layXfsUdLqnRK', NULL, '2023-06-23 07:35:14', '2023-07-08 14:41:39', 1, 0, 'Cooking', 'Tools', 1, NULL, '2000-12-12', 'assets/img/profile/', NULL, 1),
...
(40, 'test test', 'test@gmail.com', '123456789542', NULL, NULL, NULL, 'Dashuria', 'Ishurdi', 'Pabna', '1500', 'Rajshahi', 'Bangladesh', NULL, '$2y$10$gPqLqxmqE540R9Sz9OUveePx/MJGLMUTcXHmF1IEmPL/kWKod8Rim', NULL, '2023-07-06 15:57:49', '2023-07-06 15:57:49', 1, 0, 'test', 'test', 1, 'Cao Dai', '2023-06-06', 'assets/img/profile/', 'test_21794_IMG_1300.jpg', NULL),
(41, 'User Jordia', 'jordia@ofds.com', '45454531341', '95', NULL, NULL, NULL, NULL, 'Satkhira', NULL, 'Khulna', 'Bangladesh', NULL, '$2y$10$wYScX81Ckoyp1s8wQNhpb.8o5SqGZ5bnfzM3D8CXEtUzdVBlmTLVC', NULL, '2023-07-11 14:09:22', '2023-07-11 18:28:48', 1, 0, 'User', 'Jordia', 1, 'Islam', '2023-06-27', 'assets/img/profile/', 'User_22098_profile-2.jpg', NULL),
(42, 'Community Jordia', 'communityjordia@ofds.com', '8645455645', '10', 'Jordia', '10', 'Fingri', 'Satkhira Sadar', 'Satkhira', '9400', 'Khulna', 'Bangladesh', NULL, '$2y$10$BmRN0/PVvBUhFgbjToyaMO.MkY116uvpy9Re/2lKY67v73kFtlBru', NULL, '2023-07-11 14:11:10', '2023-07-11 14:11:10', 1, 0, 'Community', 'Jordia', 1, 'Islam', '2023-06-25', 'assets/img/profile/', 'Community_7786_profile-2.jpg', NULL),
(43, 'Vendor Jordia', 'vendorjordia@ofds.com', '5421212451', '95', 'Jordia', NULL, 'Fingri', 'Satkhira Sadar', 'Satkhira', '9400', 'Khulna', 'Bangladesh', NULL, '$2y$10$XZhZIFMDYefEqOhIDr/a5.8lGZyvH7BHjkBDM/oUSBr3qGjVhW.aG', NULL, '2023-07-11 14:37:42', '2023-07-11 14:54:57', 1, 0, 'Vendor', 'Jordia', 1, 'Islam', '2009-03-12', 'assets/img/profile/', 'Vendor_75045_profile-2.jpg', NULL),
(44, 'abc vd', 'abcd@ofds.com', '456545', '95', 'Jordia', '10', 'Fingri', 'Satkhira Sadar', 'Satkhira', '9400', 'Khulna', 'Bangladesh', NULL, '$2y$10$rh5XnmDGdyVAtUEjROlvk.W/.5GGuNEgAvT6QtZ.YCHD5hDNqZeE6', NULL, '2023-07-11 14:47:33', '2023-07-11 14:47:33', 1, 0, 'abc', 'vd', 2, 'Christianity', '2023-06-28', 'assets/img/profile/', 'abc_84581_profile-2.jpg', NULL),
(45, 'Community Satkhira', 'com.satkhira@ofds.com', '4154152525', NULL, NULL, NULL, 'City Corporation', 'Satkhira Sadar', 'Satkhira', '9400', 'Khulna', 'Bangladesh', NULL, '$2y$10$NMR7eZLptBXLCuJ8PPbtB.WY/SwkbDIEkYLPrH6fr6QURXxPxNnXm', NULL, '2023-07-11 17:01:45', '2023-07-11 17:04:18', 1, 0, 'Community', 'Satkhira', 1, 'Islam', '1997-07-17', 'assets/img/profile/', NULL, 1),
(46, 'satkhira admin', 'satkhiraadmin@ofds.com', '01877772226', NULL, 'satkhira', '10', 'satkhira', 'Satkhira Sadar', 'Satkhira', '9400', 'Khulna', 'Bangladesh', NULL, '$2y$10$SOU0Ni.PHJ24MoYq6KPFA.ZiEyaP1JsHtG3pFucgi1mARdVB0fZTW', NULL, '2023-08-15 15:59:20', '2023-08-15 15:59:20', 1, 0, 'satkhira', 'admin', 1, 'Islam', '1997-02-05', 'assets/img/profile/', NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `vendor_community_lists`
--

CREATE TABLE `vendor_community_lists` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `status` int(11) NOT NULL DEFAULT 1,
  `vendor_id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `vendor_community_lists`
--

INSERT INTO `vendor_community_lists` (`id`, `status`, `vendor_id`, `community_id`, `remarks`, `created_at`, `updated_at`) VALUES
(2, 1, 43, 14, 'Test', '2023-07-14 18:16:14', '2023-07-14 18:38:25');
...
--
-- Indexes for table `community_order_from_shops`
--
ALTER TABLE `community_order_from_shops`
  ADD PRIMARY KEY (`id`),
  ADD KEY `community_order_from_shop_order_id_foreign` (`order_id`),
  ADD KEY `community_order_from_shop_shop_id_foreign` (`shop_id`),
  ADD KEY `community_order_from_shop_community_id_foreign` (`community_id`);
...
--
-- Indexes for table `vendor_community_lists`
--
ALTER TABLE `vendor_community_lists`
  ADD PRIMARY KEY (`id`),
  ADD KEY `vendor_community_lists_vendor_id_foreign` (`vendor_id`),
  ADD KEY `vendor_community_lists_community_id_foreign` (`community_id`);
...
--
-- AUTO_INCREMENT for table `community_order_from_shops`
--
ALTER TABLE `community_order_from_shops`
...
--
-- AUTO_INCREMENT for table `vendor_community_lists`
--
ALTER TABLE `vendor_community_lists`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- Constraints for table `community_order_from_shops`
--
ALTER TABLE `community_order_from_shops`
  ADD CONSTRAINT `community_order_from_shop_community_id_foreign` FOREIGN KEY (`community_id`) REFERENCES `communities` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `community_order_from_shop_order_id_foreign` FOREIGN KEY (`order_id`) REFERENCES `order_products` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `community_order_from_shop_shop_id_foreign` FOREIGN KEY (`shop_id`) REFERENCES `shop_infos` (`id`) ON DELETE CASCADE;
...
--
-- Constraints for table `vendor_community_lists`
--
ALTER TABLE `vendor_community_lists`
  ADD CONSTRAINT `vendor_community_lists_community_id_foreign` FOREIGN KEY (`community_id`) REFERENCES `communities` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `vendor_community_lists_vendor_id_foreign` FOREIGN KEY (`vendor_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
COMMIT;
